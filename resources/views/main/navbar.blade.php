...
<html lang="en">
<head>
	<title>{{config('app.name', 'aplus')}}</title>
	<meta charset="UTF-8">
	...
	<header>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
						 ...
						 <!-- category start -->
						   <li>
								...
								<ul class="sub-menu">
									...
									<li><a href="#">{{$parent->parent_name}}</a>
										<ul class="sub-menu" style="position: absolute;">
                                            @foreach($parent->childs as $child)
                                            
                                              <li><a href="{{route('viewInformation', $child->child_name)}}">{{$child->child_name}}</a></li>
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						@if(Session::has('cart'))
						data-notify="{{Session::has('cart') ? Session::get('cart')->totalQty : '0'}}"
						@endif
						data-notify="0"
						>
						...
						<a href="#"  class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 dropdown-toggle" data-toggle="dropdown">
							<span><img src="{{URL::asset('user/user.png')}}" width="40" height="40"></span>
						</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="wrap-icon-header flex-w flex-r-m m-r-15">
				...
				<div class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti js-show-cart" @if(Session::has('cart'))
						data-notify="{{Session::has('cart') ? Session::get('cart')->totalQty : '0'}}"
						@endif
                        data-notify="0"
						>
		...
		<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
			<div class="container-search-header">
				<button class="flex-c-m btn-hide-modal-search trans-04 js-hide-modal-search">
					<img src="{{URL::asset('images/icons/icon-close2.png')}}" alt="CLOSE">
				</button>
...
<!--===============================================================================================-->
	...
	<script>
		...
		$('.js-addwish-detail').each(function(){
			...
			$(this).on('click', function(){
				var nameProduct=$(".wrap-modal1 #product_name").html();
				swal(nameProduct, "is added to wishlist !", "success");
